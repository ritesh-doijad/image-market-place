...
const Navbar = () => {
  return (
    <nav id='1' className='flex flex-col sm:flex-row p-5 justify-between bg-white items-start sm:items-center gap-1 sm:gap-0 shadow-md fixed right-0 left-0 z-30 top-0'>
      {/* logo and site name */}
