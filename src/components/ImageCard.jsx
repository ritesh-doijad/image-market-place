...
const ImageCard = ({id,img,auther,title,price,icon1,icon2}) => {
    return (
        <div className='rounded-lg bg-white shadow-lg p-2'>
            <div className='w-[350px] h-[25vh] sm:h-[35vh] overflow-hidden rounded-2xl'>
                <img src={img} alt="image"
                    className='object-cover w-full h-full hover:scale-105 transition-all ease-linear duration-300 transform cursor-pointer' />
            </div>
